...
GraphCC --wait $WAIT  -i $INPUT  -o $OUTPUT -n 162 --min_shared_kmers $min_shared_kmers  --max_shared_kmers $max_shared_kmers --min_reads_per_cluster $min_reads_per_cluster --n_iteration 1
EOF`
