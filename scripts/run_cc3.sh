...
GraphCC3 --wait $WAIT  -i $INPUT  -o $OUTPUT --n_iteration=18  --min_shared_kmers $min_shared_kmers --max_shared_kmers $max_shared_kmers --min_reads_per_cluster $min_reads_per_cluster
EOF`
