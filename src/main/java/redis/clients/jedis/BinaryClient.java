...
public class BinaryClient extends Connection {
  ...
  public void bf_flush_all() {
    sendCommand(BFFLUSHALL);
  }

  public void  load_module(String soPath) {
    sendCommand(MODULE, "LOAD", soPath );
  }
  ...
  public void bf_hincr(final byte[] key, final byte[] field) {
    sendCommand(BFHINCR, key, field);
  }
