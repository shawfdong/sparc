...
object Main extends LazyLogging {
  val apps: List[App] = List(KmerCounting,KmerCounting2, KmerMapReads, KmerMapReads2, GraphGen, GraphCC, GraphCC2, GraphCC3, CCAddSeq, Seq2Base64, Seq2Parquet, Repartition)
