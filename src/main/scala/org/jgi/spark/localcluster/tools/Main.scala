...
object Main extends LazyLogging {
  val apps: List[App] = List(KmerCounting,KmerCounting2, KmerMapReads, KmerMapReads2, GraphGen, GraphGen2,
    GraphCC, GraphCC2, GraphCC3,GraphLPA,GraphLPA2, CCAddSeq, Seq2Base64, Seq2Parquet, Repartition)
