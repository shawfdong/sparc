 ...
 */
@Beta
public final class MyBloomFilter<T> implements Predicate<T>, Serializable {
     ...
     */
    @CheckReturnValue
    public MyBloomFilter<T> copy() {
        return new MyBloomFilter<T>(bits.copy(), numHashFunctions, funnel, strategy);
    }
     ...
     */
    @CheckReturnValue
    public boolean isCompatible(MyBloomFilter<T> that) {
        checkNotNull(that);
        return (this != that)
     ...
     * @since 15.0
     */
    public void putAll(MyBloomFilter<T> that) {
        checkNotNull(that);
    ...
    public boolean equals(@Nullable Object object) {
        ...
        if (object instanceof MyBloomFilter) {
            MyBloomFilter<?> that = (MyBloomFilter<?>) object;
     ...
     */
    @CheckReturnValue
    public static <T> MyBloomFilter<T> create(
    ...
    @VisibleForTesting
    static <T> MyBloomFilter<T> create(
     ...
     */
        ...
        try {
            return new MyBloomFilter<T>(new BitArray(numBits), numHashFunctions, funnel, strategy);
     ...
     */
    @CheckReturnValue
    public static <T> MyBloomFilter<T> create(Funnel<? super T> funnel, int expectedInsertions) {
     ...
     */
    @CheckReturnValue
    public static <T> MyBloomFilter<T> create(Funnel<? super T> funnel, long expectedInsertions) {
   ...
   */
    ...
    private static class SerialForm<T> implements Serializable {
        ...
        Object readResolve() {
            return new MyBloomFilter<T>(new BitArray(data), numHashFunctions, funnel, strategy);
        }
     ...
     */
    @CheckReturnValue
    public static <T> MyBloomFilter<T> readFrom(InputStream in, Funnel<T> funnel) throws IOException {
