 ...
 */
enum GuavaBloomFilterStrategies implements GuavaBloomFilter.Strategy {
    /**
    ...
    MURMUR128_MITZ_32() {
        ...
        public <T> boolean put(
                T object, Funnel<? super T> funnel, int numHashFunctions, GuavaBitArray bits) {
    ...
    static final class GuavaBitArray {
        final long[] data;
        long bitCount;

        GuavaBitArray(long bits) {
            this(new long[Ints.checkedCast(LongMath.divide(bits, 64, RoundingMode.CEILING))]);
        }

        // Used by serialization
        GuavaBitArray(long[] data) {
        ...
        GuavaBitArray copy() {
            return new GuavaBitArray(data.clone());
        }

        /**
         * Combines the two BitArrays using bitwise OR.
         */
        void putAll(GuavaBitArray array) {
            checkArgument(
        ...
        public boolean equals(Object o) {
            if (o instanceof GuavaBitArray) {
                GuavaBitArray bitArray = (GuavaBitArray) o;
